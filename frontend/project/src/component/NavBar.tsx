...
const NavBar = () => {
  const isActive = (path: string) => {
    ...
    return window.location.pathname === path ? "bg-primary text-white" : "";
  };
  return (
    <>
      <nav className="bg-base-100/80 backdrop-blur-lg border-b border-primary/20 sticky top-0 z-50 shadow-lg">
